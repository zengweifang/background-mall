...
@Component({
  selector: 'app-channel-check-order-goods-list',
  templateUrl: './channel-check-order-goods-list.component.html',
  styleUrls: ['./channel-check-order-goods-list.component.css']
})
export class ChannelCheckOrderGoodsListComponent implements OnInit {
    constructor(
    ...
    @Output() isSelectedGood = new EventEmitter<boolean>();
    ...
    _refreshStatus() {
        ...
        this.isSelectedGood.emit(this._isSelected(this._dataSet));
    };
