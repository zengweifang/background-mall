...
@Component({
    selector:'edit-commoditypools-component',
    templateUrl:'./edit.component.html',
    styleUrls:['../../../app.component.scss']
})

export class EditCommoditypoolsComponent implements OnInit{
    ...
    emitDataOutside(){
        ...
        // this.CommoditypoolsService.saveApartmentDetail(this.apartmentInfo).then(res => {
        //     res["status"] = true;
        //     setTimeout(() => {
        ...
        // this.CommoditypoolsService.update(this.editParams).then(res=>{
        //     console.log(res)
        // })
    ...
    getCommoditypoolsInfo(id){
        this.CommoditypoolsService.getCommoditypoolsInfo(id).then(res=>{
            console.log(res)
        })
    }
    ...
    ngOnInit(){
        ...
        // this.CommoditypoolsService.getApartmentDetail(this._id).then(res => this.apartmentInfo = res.data)
    }
